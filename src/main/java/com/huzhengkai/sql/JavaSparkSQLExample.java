...
//        runInferSchemaExample(spark);
    ...
    {
        // $example on:create_df$
        Dataset<Row> df = spark.read().json("D:\\IDEA\\spark_2_1_1\\src\\main\\resources\\people.json");
    ...
    private static void runDatasetCreationExample(SparkSession spark)
    {
        ...
        String path = "D:\\IDEA\\spark_2_1_1\\src\\main\\resources\\people.json";
    ...
    private static void runInferSchemaExample(SparkSession spark)
    {
        ...
        JavaRDD<Person> peopleRDD = spark.read()
                .textFile("D:\\IDEA\\spark_2_1_1\\src\\main\\resources\\people.txt")
                .javaRDD()
    ...
    private static void runProgrammaticSchemaExample(SparkSession spark)
    {
        ...
        JavaRDD<String> peopleRDD = spark.sparkContext()
                .textFile("D:\\IDEA\\spark_2_1_1\\src\\main\\resources\\people.txt", 1)
                .toJavaRDD();
